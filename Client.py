...
def display_message(screen, message):
    """
    :param screen: the screen. message: the message the server passed (It's your turn)
    """
    try:
...
def create_new_screen(screen, is_your_turn):
    ...
    if is_your_turn:
        ...
        pygame.draw.rect(screen, GREEN_COLOR,(ZERO, WINDOW_HEIGHT - BOUNDARY_THICKNESS, WINDOW_WIDTH, BOUNDARY_THICKNESS))  # Bottom boundary
        pygame.draw.rect(screen, GREEN_COLOR,(WINDOW_WIDTH - BOUNDARY_THICKNESS, ZERO, BOUNDARY_THICKNESS, WINDOW_HEIGHT))  # Right boundary
...
def handle_mouse_click(event, screen):
    """
    :param event: the event. screen: the screen
